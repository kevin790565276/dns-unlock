...
ALL_DOMAINS=(
    ...
    # --- Google 全家桶 (确保 Play Store / Search 解锁) ---
...
EOF
    ...
    echo -e "${GREEN}[+] 配置已生效！流媒体全域名已指向解锁 IP，且 IPv6 保持原生。${NC}"
